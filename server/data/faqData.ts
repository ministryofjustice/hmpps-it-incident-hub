  ...
  vsip: {
    ...
    faqs: [
      ...
      },
      {
        ...
        body: 'The dates and times of available sessions shown in the service are dependent on a few things: There may be a non-association with another prisoner who is already booked into the session. The prisoner might not have the required incentive level for that particular session. The visitor might have a closed restriction which means they can only  have closed visits and there are no closed slots available on that session. The session has a local restriction (for example its only for a prisoners in a particular wing) and the prisoner does not meet the criteria. The service takes all these factors into account when presenting available sessions for a specific prisoner and their visitor(s).',
      },
      {
        id: 5,
        heading: 'How can I get access to the service?',
        body: 'In order to access the service your establishment needs to have been onboarded. The VSiP team will work with you to understand your specific needs before we onboard your establishment. If you are interested in using the service to manage your establishments social face to face visits, you can complete this short form here and the team will get in touch with you: https://forms.office.com/e/K1ThmV7GmT ',
      },
      {
        id: 6,
