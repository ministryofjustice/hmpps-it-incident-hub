...
describe('Service Now Service', () => {
  ...
  describe('createIncident', () => {
    it('should return a ServiceNow response from the Service Now API', async () => {
      ...
      const output = await service.createIncident(category, subcategory, email, shortDescription, description)
